...
BaseApplication.prototype.init_int = function() {
  ...
  var _self = this;
  //this.m_canvas_elm.onmousemove = function(e) {_self.mouse_move(e)}
  document.onkeydown = function(e) {_self.key_down(e)} 
  document.onkeyup = function(e) {_self.key_up(e)}
  this.stopped = false;
  if (on_frame) {
...
//==============================================================================
// Stop all before the destroy
BaseApplication.prototype.stop_all = function() {
...
BaseApplication.prototype.mouse_move = function(e) {
  this.m_mouse.x = e.clientX - this.m_canvas_elm.offsetLeft;
  this.m_mouse.y = e.clientY - this.m_canvas_elm.offsetTop;
}
